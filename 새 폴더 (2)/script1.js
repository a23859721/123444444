...
const keywordDB_default = {
    "help": { type: "text", value: "이름, 직업, 생일, MBTI, 좋아하는색,나이 " },
...
function handleUserInput() {
    ...
    if (value === "정동효") {
        ...
        addChatMessage("정동효로 전환되었습니다. 새로운 키워드를 입력해보세요!", true);
